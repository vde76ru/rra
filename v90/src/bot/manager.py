...
class BotManager:
    ...
    def _init_components(self):
        ...
        try:
            ...
            logger.warning(f"⚠️ Не удалось инициализировать Market Analyzer: {e}")
        ...
        try:
            ...
            logger.warning(f"⚠️ Не удалось инициализировать Trader: {e}")
        ...
        try:
            ...
            logger.warning(f"⚠️ Не удалось инициализировать Risk Manager: {e}")
        ...
        try:
            ...
            logger.warning(f"⚠️ Не удалось инициализировать Telegram Notifier: {e}")
        
        try:
            # Фабрика стратегий
            from ..strategies import strategy_factory
            self.strategy_factory = strategy_factory
            logger.info("✅ Strategy Factory инициализирована")
        except Exception as e:
            logger.warning(f"⚠️ Не удалось инициализировать Strategy Factory: {e}")
