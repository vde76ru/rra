"""
API для графиков и реального времени - ИСПРАВЛЕННЫЕ ИМПОРТЫ
...
class ChartAPI:
    ...
    def _register_routes(self):
        ...
        async def get_latest_news():
            ...
            try:
                db = SessionLocal()
                news = db.query(NewsAnalysis)\
                    .order_by(NewsAnalysis.published_at.desc())\
                    .limit(20)\
                    .all()
                ...
                return jsonify({
                    ...
                    'news': [{
                        ...
                        'affected_coins': n.affected_coins,
        ...
        async def get_social_signals():
            ...
            try:
                db = SessionLocal()
                signals = db.query(SocialSignal)\
                    .order_by(SocialSignal.created_at.desc())\
                    .limit(50)\
                    .all()
                ...
                return jsonify({
                    ...
                    'signals': [{
                        ...
                        'platform': s.platform,
                        'author': s.author,
                        'author_followers': s.author_followers,
                        'content': s.content,
                        'sentiment': s.sentiment,
                        'influence_score': s.influence_score,
                        'mentioned_coins': s.mentioned_coins,
                        'is_verified_author': s.is_verified_author,
        ...
        @login_required
        def news_page():
            """Страница новостей и социальных сигналов"""
