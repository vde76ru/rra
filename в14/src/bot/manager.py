...
from ..notifications.telegram import telegram_notifier  # ✅ Используем глобальный экземпляр
...
class BotManager:
    ...
    def __init__(self):
        ...
        if not BotManager._initialized:
            ...
            self.notifier = telegram_notifier  # ✅ Используем глобальный экземпляр
        ...
        try:
            ...
            try:
                for currency, amount in balance.items():
                    from ..core.models import Balance  # ✅ Добавляем импорт
                    if amount['total'] > 0:
    ...
    def _save_statistics(self):
        ...
        try:
            ...
            if state:
                ...
                from sqlalchemy import func  # ✅ Добавляем импорт
