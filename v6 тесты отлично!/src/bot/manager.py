        ...
        try:
            ...
            for market in markets:
                market.update({
                    ...
                    'high_24h': np.random.uniform(market['price'], market['price'] * 1.1),
                    'low_24h': np.random.uniform(market['price'] * 0.9, market['price']),
                    'trades_count': np.random.randint(1000, 100000),
                    'bid': market['price'] * 0.999,
                    'ask': market['price'] * 1.001,
                    'spread': market['price'] * 0.002
                })
