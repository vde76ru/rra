"""
Модели базы данных для торгового бота
Путь: /var/www/www-root/data/www/systemetech.ru/src/core/models.py
"""

from sqlalchemy import Column, Integer, String, Float, DateTime, Text, JSON, Boolean, Enum, ForeignKey, Index
...
# Расширенная модель для сигналов
class Signal(Base):
