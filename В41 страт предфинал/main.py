...
async def run_web_only():
    ...
    """
    global web_app, bot_manager
    
    logger.info("🌐 === ЗАПУСК ВЕБА В РЕЖИМЕ WEB-ONLY ===")
    
    try:
        # === ШАГ 1: СОЗДАЕМ BOT MANAGER ===
        logger.info("🤖 Создаем BotManager для веб-интерфейса...")
        bot_manager = BotManager()
        
        # Устанавливаем bot_manager в api_routes
        from src.web.api_routes import set_bot_manager
        set_bot_manager(bot_manager)
        logger.info("✅ BotManager создан и установлен")
